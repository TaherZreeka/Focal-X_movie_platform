...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo e(route('home')); ?>" class="brand-link d-flex align-items-center">
        ...
        <span class="brand-text font-weight-light ml-2">Focal X Agent</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <?php elseif(Auth::user()->name == 'content_admin'): ?>
                <!-- ShowTimes -->
                <li class="nav-item has-treeview">
    ...
    <!-- /.sidebar -->
</aside><?php /**PATH C:\xampp\htdocs\focal x\Focal_X-Graduation-Project\Movie_Platform_Management_System\resources\views/content_admin/layout/sidebar.blade.php ENDPATH**/ ?>