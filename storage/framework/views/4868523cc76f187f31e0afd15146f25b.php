    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="small-box bg-info">
              ...
              <a href="<?php echo e(route('movies.index')); ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
           <div class="col-lg-3 col-6">
            <!-- small box -->
            <div class="small-box bg-warning" >
              ...
              <a href="<?php echo e(route('reviews.index')); ?>" class="small-box-footer">More info
...
<?php echo $__env->make('content_admin.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\focal x\Focal_X-Graduation-Project\Movie_Platform_Management_System\resources\views/content_admin/dashboard.blade.php ENDPATH**/ ?>