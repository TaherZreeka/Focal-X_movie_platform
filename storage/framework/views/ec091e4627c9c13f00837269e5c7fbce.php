<?php $__env->startSection('title', 'Content Administrators List'); ?>
            ...
            <div class="card">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="w-100 bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 d-flex justify-content-center align-items-center"
                        style="height: 100px;">
                        <h1 class="text-white text-capitalize m-0" style="font-size: 32px;">List Of Content
                            Administrators</h1>
                    </div>
                    ...
                    <table class="table table-striped projects text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('admin.content.show', $user->id)); ?>"
                                    ...
                                    <form action="<?php echo e(route('admin.content.destroy', $user->id)); ?>" method="POST"
                                        class="d-inline"
                            ...
                            <tr>
                                <td colspan="4" class="text-muted">No content administrators available.</td>
                            </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
...
<?php echo $__env->make('content_admin.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\training XFocal\Focal-X_movie_platform\resources\views/admin/content/index.blade.php ENDPATH**/ ?>