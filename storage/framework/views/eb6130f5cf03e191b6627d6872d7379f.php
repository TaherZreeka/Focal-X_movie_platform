                    ...
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            ...
                            <select name="genres[]" multiple required class="w-full border rounded px-3 py-2">
                                ...
                                <option value="<?php echo e($genre->id); ?>" <?php echo e(in_array($genre->id, old('genres', [])) ? 'selected'
                                    : ''); ?>>
...
<?php echo $__env->make('content_admin.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\focal x\Focal_X-Graduation-Project\Movie_Platform_Management_System\resources\views/content_admin/movies/create.blade.php ENDPATH**/ ?>