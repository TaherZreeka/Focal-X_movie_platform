                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input type="url" id="poster" name="poster_url"accept="image/*" class="form-control" value="<?php echo e(old('poster_url')); ?>"
                                    required>
                            </div>
                            <div class="form-group">
                                <label for="trailer_url">trailer</label>
                                <input type="url" id="trailer_url" name="trailer_url"accept="video/*" class="form-control" value="<?php echo e(old('trailer_url')); ?>"
                                    required>
                            </div>

                            <div class="form-group">
                                <label for="movie_url">movie</label>
                                <input type="file" id="movie_url" name="movie_url"accept="video/*" class="form-control" value="<?php echo e(old('movie_url')); ?>"
                                    required>
                            </div>
                            <div class="form-group">
...
<?php echo $__env->make('content_admin.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\rag\focla-x\Focal-X_movie_platform\resources\views/content_admin/movies/create.blade.php ENDPATH**/ ?>