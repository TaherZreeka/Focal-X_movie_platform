    ...
    <div class="sidebar">
       ...
       <nav class="mt-2">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview">
                    <a href="#" class="nav-link  <?php echo e(request()->is('movies*') ? 'active' : ''); ?>"> 
                        <i class="nav-icon fas fa-book"></i>
                        <p>
                            Movies
                            <i class="fas fa-angle-left right"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="/movies" class="nav-link<?php echo e(request()->routeIs('index') ? 'active' : ''); ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>index</p>
                            </a>
                        </li>
...
<?php /**PATH C:\mo\Focal-X_movie_platform\resources\views\content_admin\layout\sidebar.blade.php ENDPATH**/ ?>