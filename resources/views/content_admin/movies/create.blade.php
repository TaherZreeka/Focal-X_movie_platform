                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input type="url" id="poster" name="poster_url"aaccept="image/*" class="form-control" value="{{ old('poster_url') }}"
                                    required>
                            </div>
                            <div class="form-group">
                                <label for="trailer_url">trailer</label>
                                <input type="url" id="trailer_url" name="trailer_url"aaccept="video/*" class="form-control" value="{{ old('trailer_url') }}"
                                    required>
                            </div>

                            <div class="form-group">
                                <label for="movie_url">movie</label>
                                <input type="file" id="movie_url" name="movie_url"aaccept="video/*" class="form-control" value="{{ old('movie_url') }}"
                                    required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select id="language" name="language" class="form-control custom-select" required>
                                    ...
                                    <option value="Franch" {{ old('language')=='Franch' ? 'selected' : '' }}>Franch
                                    </option>
                            ...
                            <div class="form-group">
                                ...
                                <select id="age_rating" name="age_rating" class="form-control custom-select" required>
                                    <option selected disabled>Select one</option>
                                    <option value="G" {{ old('age_rating')=='G' ? 'selected' : '' }}>G
                                    </option>
                                    <option value="R" {{ old('age_rating')=='R' ? 'selected' : '' }}>R
                                    </option>
                                    <option value="NC-17" {{ old('age_rating')=='NC-17' ? 'selected' : '' }}>NC-17
                                    </option>
                                    <option value="PG-13" {{ old('age_rating')=='PG-13' ? 'selected' : '' }}>PG-13
                                    </option>
                                    <option value="PG" {{ old('age_rating')=='PG' ? 'selected' : '' }}>PG
                                    </option>
