    ...
    <div class="sidebar">
       ...
       <nav class="mt-2">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview">
                    <a href="#" class="nav-link {{ request()->is('content_admin/movies*') ? 'active' : '' }}">
                        <i class="nav-icon fas fa-book"></i>
                        <p>
                            Movies
                            <i class="fas fa-angle-left right"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="content_admin/movies" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>index</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="content_admin/movies/create" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Movie Add</p>
                            </a>
                        </li>
